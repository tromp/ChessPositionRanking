...
In fact, these 52 are all the legal positions among a sample generated by picking 1000 random integers in a specific range, and converting each integer into a corresponding position. Hovering over each position will show its rank, as we call it.
...
It uses [Forsyth–Edwards Notation](https://en.wikipedia.org/wiki/Forsyth%E2%80%93Edwards_Notation) for input and output, with the following modifications:
