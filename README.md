...
In fact, these 52 are all the legal positions among a sample generated by picking 1000 random integers in a specific range, and converting each integer into a corresponding position.
